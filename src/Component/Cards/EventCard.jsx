            ...
            <div className='flex gap-8 overflow-auto p-4'>
                {
                    eventData.map((val, index) => {
                        return (
                            <div key={index} className='min-w-[250px] flex flex-col bg-white shadow-md rounded-lg overflow-hidden cursor-pointer transition-transform duration-200 hover:scale-105'>
