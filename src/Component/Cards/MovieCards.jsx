            ...
            <div className='flex gap-8 overflow-auto p-4'>
                {
                    movieData.map((val, id) => {
                        return (
                            <div key={id} className='h-[480px] pb-4 min-w-[280px] flex flex-col bg-white shadow-md rounded-lg overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-105'
